...
- [UE 资产合作与自动搭建工作流](reference_ui_widget_pattern.md) — C++/Python/DA/MID 分层协作；UE 5.6 材质脚本先查已验证签名，禁止猜 API
...
- [打包封装交接文档](kimmelrebirth-packaging-handoff.md) —— KimmelRebirth 打包封装最新交接文档指针
