...
metadata: 
  ...
  modified: 2026-08-13T16:47:09.938Z
---
...
```
+DirectoriesToAlwaysCook=/Game/JadeBetting   ; 强制整目录进包
+MapsToCook=/Game/.../Map_X.Map_X            ; 显式列地图
```
纯 ini 改动，无需编译，直接重新打包即生效。打包后用 `Manifest_UFSFiles_Win64.txt` 复核动态加载资产是否进了包。
